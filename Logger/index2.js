...
const labels = {
  0: 'EMERGENCY ', // color windows 101
  1: 'ERROR**** ', // color windows 91
  2: 'WARNING** ', // color windows 93
  3: 'INFO***** ', // color windows 96
  4: 'DEBUG**** ', // color windows 92
  5: 'TRACE**** '  // color windows 95
};
  ...
  initLogger: (options) => {
    if (logger) {
      logger.emergency(`
        ...
        RETURNING ALREADY INSTANTIATED LOGGER SINGLETON.
      `);
      return logger;
    }
